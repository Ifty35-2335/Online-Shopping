...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set name='$name',contactno='$contactno',address='$address' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['address'];?>" id="address" name="addres" required="required">
					  </div>
